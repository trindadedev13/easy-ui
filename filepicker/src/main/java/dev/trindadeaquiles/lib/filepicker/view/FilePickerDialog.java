package dev.trindadeaquiles.lib.filepicker.view;
...
import dev.trindadeaquiles.lib.filepicker.controller.DialogSelectionListener;
import dev.trindadeaquiles.lib.filepicker.controller.NotifyItemChecked;
import dev.trindadeaquiles.lib.filepicker.controller.adapters.FileListAdapter;
import dev.trindadeaquiles.lib.filepicker.model.DialogConfigs;
import dev.trindadeaquiles.lib.filepicker.model.DialogProperties;
import dev.trindadeaquiles.lib.filepicker.model.FileListItem;
import dev.trindadeaquiles.lib.filepicker.model.MarkedItemList;
import dev.trindadeaquiles.lib.filepicker.utils.ExtensionFilter;
import dev.trindadeaquiles.lib.filepicker.utils.Utility;
import dev.trindadeaquiles.lib.filepicker.widget.MaterialCheckbox;
...
public class FilePickerDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public int getColor(int name) {
       return getColorFromStyle(context, R.style.AppTheme, name);
    }
